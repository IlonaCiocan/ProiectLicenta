...
namespace ProiectLicenta.Interfata.UserControls
{
    public partial class UserControlNewAccount : UserControl
    {
            ...
            if (this.canProceed == true)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (login.NewUser(this.textBox_user.Text.ToString(), this.textBoxPassword.Text.ToString(), "1", this.textBoxServiciul.Text.ToString(),this.mainForm.user) == 0)
                            {
                            ...
                            {
                                var result = MessageBox.Show("Utilizatorul a fost creat cu succes!");
                        ...
                        else
                        {
                            if (main == false)
                            {
                                if (login.NewUser(this.textBox_user.Text.ToString(), this.textBoxPassword.Text.ToString(), "0", this.textBoxServiciul.Text.ToString(), this.mainForm.user) == 0)
                                {
                                    MessageBox.Show("nereusit");
        ...
        private void RefreshContent()
        {
            ...
            this.textBoxRetype.Text = "";
            this.textBox_user.Text = "";
            this.textBoxServiciul.Text = "";
            this.checkBox_admin.Checked = false;
            textBox_user.ForeColor = SystemColors.GrayText;
            textBox_user.Text = "Nume utilizator";
            this.textBox_user.Leave += new System.EventHandler(this.textBox_user_Leave);
            this.textBox_user.Enter += new System.EventHandler(this.textBox_user_Enter);
